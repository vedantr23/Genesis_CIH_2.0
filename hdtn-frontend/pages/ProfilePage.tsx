...
const ProfilePage: React.FC = () => {
  return (
    <div className="p-6 bg-slate-800 rounded-lg shadow-xl h-full flex flex-col">
      ...
      <div
        className="flex-grow bg-slate-700 rounded-md relative"
      ...
      <div className="mt-6 p-4 bg-slate-700 rounded-md">
        <h2 className="text-2xl font-semibold text-cyan-300 mb-2">
          Vedant Raut (Mock User)
        </h2>
        <p className="text-slate-300">
          Passionate developer exploring the frontiers of web technology and
          digital identity. This is a preview of my digital avatar.
        </p>
      </div>
    </div>
  );
